...
class macroPass1:
    def __init__(self):
        ...
        self.keywordParamDefTable = []
        self.keywordParamDefTablePointer = 1
        self.paramNameTable = {}
    ...
    def convertToTuple(self,param,current_macro):
        ...
        for line in lines:
            ...
            if part_1 == "MACRO":
                ...
                if keywordParamCount == 0:
                    ...
                    self.macroNameTable[part_1] = [positionalParamCount,keywordParamCount,self.macroDefTablePointer,self.keywordParamDefTablePointer]
                self.keywordParamDefTablePointer+=keywordParamCount
                ...
                for param in part_2:
                    find = default.search(param)
                    if find!=None:
                        self.macroDefTable[-1].append(self.convertToTuple(find.group(1),currentMacroName))
                    else:
...
obj = macroPass1()
obj.parseFile()
obj.writeKeywordParamDefTable()
obj.writeMacroDefTable()
obj.writeMacroNameTable()
obj.writeParamNameTable()